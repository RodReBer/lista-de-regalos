...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    ...
    >
      ...
      <div
        ref={containerRef}
        className="pointer-events-none absolute inset-x-0 bottom-0 h-full w-full bg-background"
        style={{
          boxShadow:
...
>(({ parentRef, containerRef, beamOptions = {} }, ref) => {
  ...
  return (
    <>
      ...
      />
      <AnimatedBeam beamOptions={beamOptions} collision={collision} parentRef={parentRef} />
    </>
  )
})
